package com.healthcare.providerservice.config;

import com.healthcare.providerservice.security.JwtAuthFilter;
            ...
            .exceptionHandling(ex -> ex.authenticationEntryPoint((req, res, e) -> {
                ...
                new ObjectMapper().writeValue(res.getOutputStream(),
                        new ApiError(401, "UNAUTHORIZED", "Missing or invalid token",
                                cid == null ? null : String.valueOf(cid), "provider-service"));
            }))
